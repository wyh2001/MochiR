...
import { ApiResponseOfUserLockResponseDto } from '../../models/api-response-of-user-lock-response-dto';
import { LockUserRequestDto } from '../../models/lock-user-request-dto';
...
apiUsersIdLockPost.PATH = '/api/users/{id}/lock';
