...
import { ApiResponseOfFollowSubjectTypePageDto } from '../../models/api-response-of-follow-subject-type-page-dto';

export interface ApiFollowsSubjectTypesGet$Params {
  Page?: number;
  PageSize?: number;
}
...
apiFollowsSubjectTypesGet.PATH = '/api/follows/subject-types';
