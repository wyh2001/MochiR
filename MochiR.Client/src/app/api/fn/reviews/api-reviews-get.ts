...
import { ApiResponseOfIReadOnlyListOfReviewSummaryDto } from '../../models/api-response-of-i-read-only-list-of-review-summary-dto';

export interface ApiReviewsGet$Params {
  subjectId?: number;
  userId?: string;
}
...
apiReviewsGet.PATH = '/api/reviews';
