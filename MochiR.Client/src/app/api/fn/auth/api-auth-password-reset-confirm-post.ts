...
import { ApiResponseOfPasswordResetConfirmResponseDto } from '../../models/api-response-of-password-reset-confirm-response-dto';
...
apiAuthPasswordResetConfirmPost.PATH = '/api/auth/password/reset/confirm';
